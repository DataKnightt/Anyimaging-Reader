...
#include "view/dicom3d/vrraycast.h"
...
public:
    ...
    void SetOperation(const RoateFlipOperation & operation);
    void SetOperation(const PreProcessOperation& operation);
    // 翻转操作
    ...
    void SetOperation(const MPRVROperation& operation); //三维操作
...
private:
    ...
    QGraphicsSimpleTextItem * curFrameItem; // 显示当前帧
